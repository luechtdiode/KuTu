...
class RegistrationRoutesAdditionalSpec extends KuTuBaseSpec {

  private val wk: Wettkampf = insertGeTuWettkampf("RegistrationRoutesAdditional", 0)
  ...
  "registration routes additional coverage" should {
