...
class RollbackableStringProperty(bean: Object = null, name: String = null, initialValue: String = null)
  extends SimpleStringProperty(bean, name, initialValue) with Rollbackable[String] {

  def this(initialValue_ : String) = this(initialValue = initialValue_)

  def this(bean_ : Object, name_ : String) = this(bean = bean_, name = name_, initialValue = null)
