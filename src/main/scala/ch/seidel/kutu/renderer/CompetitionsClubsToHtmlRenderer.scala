...
trait CompetitionsClubsToHtmlRenderer {
  ...
  private def anmeldeListeProVerein(wettkampf: Wettkampf, vereine: Seq[Registration], logo: File) = {
  ...
  def toHTMLasClubRegistrationsList(wettkampf: Wettkampf, vereine: Seq[Registration], logo: File, rowsPerPage: Int = 28): String = {
